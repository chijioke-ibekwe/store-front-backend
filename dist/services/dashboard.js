...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.topFiveMostPopularProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT p.id, p.name, p.price, p.category, COUNT(o.id) as number_of_orders FROM products p JOIN orders_products op ON ' +
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("Cannot fetch most popular products: ".concat(error_1));
